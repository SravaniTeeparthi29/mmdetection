...
def random_shear_value(value, random_negative_prob):
    """Randomly negate value based on random_negative_prob."""
    value = np.random.choice(np.arange(0, value, (value/100)))
    return -value if np.random.rand() < random_negative_prob else value


def random_rotate_value(value, random_negative_prob):
    """Randomly negate value based on random_negative_prob."""
    value = np.random.choice(np.arange(0, value, (value/100)))
    return -value if np.random.rand() < random_negative_prob else value


def random_translate_value(value, random_negative_prob):
    """Randomly negate value based on random_negative_prob."""
    value = np.random.choice(np.arange(0, value, (value/100)))
    return -value if np.random.rand() < random_negative_prob else value
...
class CustomShear(object):
    ...
    def __call__(self, results):
        ...
        magnitude = random_shear_value(self.magnitude, self.random_negative_prob)
...
class CustomRotate(object):
    ...
    def __call__(self, results):
        ...
        angle = random_rotate_value(self.angle, self.random_negative_prob)
...
class CustomTranslate(object):
    ...
    def __call__(self, results):
        ...
        offset = random_translate_value(self.offset, self.random_negative_prob)
